...
RocketReader.prototype.initReader = function(topic, channel, replier, store) {
    ...
    logger.info({object: 'Reader', topic: topic, channel: channel})
...
RocketReader.prototype.incomingMessage = function(reader, store, replier) {
    return (msg) => {
        ...
        logger.info({object: 'Message', topic: reader.topic, pattern: msg.headers.pattern})
        ...
        logger.warn({object: 'Message', topic: reader.topic, pattern: msg.headers.pattern, error: 'pattern not found'})
